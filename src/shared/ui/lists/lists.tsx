...
const tableTdBaseClasses =
  "bg-white border border-[color:var(--color-gray-200,#e5e5e5)] border-t-0 border-l-0 min-h-[56px] px-5 py-4 text-[color:var(--color-gray-800,#333)] text-[14px] leading-[1.43] tracking-[-0.35px]";
